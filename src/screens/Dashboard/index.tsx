...
export function Dashboard() {
  ...
  function handleRepositoryPageNavigation(id: number) {
    /**
     * DONE - navigate to the Repository screen sending repository id.
        ...
        <AddGithubRepo>
          ...
          <Input>
            <InputField
              ...
              value={inputText}
              /**
               * DONE - update inputText value when input text value
               * changes:
            ...
            <InputButton
              ...
              /**
               * DONE - ensure to disable button when inputText is
